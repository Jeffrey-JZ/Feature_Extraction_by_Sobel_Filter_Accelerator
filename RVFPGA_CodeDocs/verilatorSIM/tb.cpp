...
int main(int argc, char **argv, char **env)
{
  ...
  while (!(done || Verilated::gotFinish())) {
    ...
    }                       // It will be done if the simulation time = value time out
    top->clk = !top->clk;   // The Clock signal of SoC is created here
    main_time+=10;          // Clock cycle = 20 ns, Clock pulse = 10ns
