...
// Sobel Accelerator
wire [31:0] wb_m2s_sobel_adr;
wire [31:0] wb_m2s_sobel_dat;
wire  [3:0] wb_m2s_sobel_sel;
wire        wb_m2s_sobel_we;
wire        wb_m2s_sobel_cyc;
wire        wb_m2s_sobel_stb;
wire  [2:0] wb_m2s_sobel_cti;
wire  [1:0] wb_m2s_sobel_bte;
wire [31:0] wb_s2m_sobel_dat;
wire        wb_s2m_sobel_ack;
wire        wb_s2m_sobel_err;
wire        wb_s2m_sobel_rty;
...
// Sobel Accelerator
    .wb_sobel_adr_o (wb_m2s_sobel_adr),
    .wb_sobel_dat_o (wb_m2s_sobel_dat),
    .wb_sobel_sel_o (wb_m2s_sobel_sel),
    .wb_sobel_we_o  (wb_m2s_sobel_we),
    .wb_sobel_cyc_o (wb_m2s_sobel_cyc),
    .wb_sobel_stb_o (wb_m2s_sobel_stb),
    .wb_sobel_cti_o (wb_m2s_sobel_cti),
    .wb_sobel_bte_o (wb_m2s_sobel_bte),
    .wb_sobel_dat_i (wb_s2m_sobel_dat),
    .wb_sobel_ack_i (wb_s2m_sobel_ack),
    .wb_sobel_err_i (wb_s2m_sobel_err),
    .wb_sobel_rty_i (wb_s2m_sobel_rty));
