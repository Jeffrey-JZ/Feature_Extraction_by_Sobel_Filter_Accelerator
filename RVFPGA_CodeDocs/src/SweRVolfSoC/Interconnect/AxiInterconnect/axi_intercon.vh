...
// Sobel DMA AXI master
wire  [3:0] sobel_awid;
wire [31:0] sobel_awaddr;
wire  [7:0] sobel_awlen;
wire  [2:0] sobel_awsize;
wire  [1:0] sobel_awburst;
wire        sobel_awlock;
wire  [3:0] sobel_awcache;
wire  [2:0] sobel_awprot;
wire  [3:0] sobel_awregion;
wire  [3:0] sobel_awqos;
wire        sobel_awvalid;
wire        sobel_awready;
wire  [3:0] sobel_arid;
...
wire  [3:0] sobel_arregion;
wire  [3:0] sobel_arqos;
wire        sobel_arvalid;
wire        sobel_arready;
wire [63:0] sobel_wdata;
wire  [7:0] sobel_wstrb;
wire        sobel_wlast;
wire        sobel_wvalid;
wire        sobel_wready;
wire  [3:0] sobel_bid;
wire  [1:0] sobel_bresp;
wire        sobel_bvalid;
wire        sobel_bready;
wire  [3:0] sobel_rid;
wire [63:0] sobel_rdata;
wire  [1:0] sobel_rresp;
wire        sobel_rlast;
wire        sobel_rvalid;
wire        sobel_rready;
...
axi_intercon axi_intercon
   ...
   // Sobel DMA
    .i_sobel_awid     (sobel_awid),
    .i_sobel_awaddr   (sobel_awaddr),
    .i_sobel_awlen    (sobel_awlen),
    .i_sobel_awsize   (sobel_awsize),
    .i_sobel_awburst  (sobel_awburst),
    .i_sobel_awlock   (sobel_awlock),
    .i_sobel_awcache  (sobel_awcache),
    .i_sobel_awprot   (sobel_awprot),
    .i_sobel_awregion (sobel_awregion),
    .i_sobel_awqos    (sobel_awqos),
    .i_sobel_awvalid  (sobel_awvalid),
    .o_sobel_awready  (sobel_awready),
    .i_sobel_arid     (sobel_arid),
    .i_sobel_araddr   (sobel_araddr),
    .i_sobel_arlen    (sobel_arlen),
    .i_sobel_arsize   (sobel_arsize),
    .i_sobel_arburst  (sobel_arburst),
    .i_sobel_arlock   (sobel_arlock),
    .i_sobel_arcache  (sobel_arcache),
    .i_sobel_arprot   (sobel_arprot),
    .i_sobel_arregion (sobel_arregion),
    .i_sobel_arqos    (sobel_arqos),
    .i_sobel_arvalid  (sobel_arvalid),
    .o_sobel_arready  (sobel_arready),
    .i_sobel_wdata    (sobel_wdata),
    .i_sobel_wstrb    (sobel_wstrb),
    .i_sobel_wlast    (sobel_wlast),
    .i_sobel_wvalid   (sobel_wvalid),
    .o_sobel_wready   (sobel_wready),
    .o_sobel_bid      (sobel_bid),
    .o_sobel_bresp    (sobel_bresp),
    .o_sobel_bvalid   (sobel_bvalid),
    .i_sobel_bready   (sobel_bready),
    .o_sobel_rid      (sobel_rid),
    .o_sobel_rdata    (sobel_rdata),
    .o_sobel_rresp    (sobel_rresp),
    .o_sobel_rlast    (sobel_rlast),
    .o_sobel_rvalid   (sobel_rvalid),
    .i_sobel_rready   (sobel_rready),
