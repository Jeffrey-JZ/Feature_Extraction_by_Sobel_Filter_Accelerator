...
module axi_intercon
   (input  wire        clk_i,
    ...
    // Sobel DMA master
    input  wire  [3:0] i_sobel_awid,
    input  wire [31:0] i_sobel_awaddr,
    input  wire  [7:0] i_sobel_awlen,
    input  wire  [2:0] i_sobel_awsize,
    input  wire  [1:0] i_sobel_awburst,
    input  wire        i_sobel_awlock,
    input  wire  [3:0] i_sobel_awcache,
    input  wire  [2:0] i_sobel_awprot,
    input  wire  [3:0] i_sobel_awregion,
    input  wire  [3:0] i_sobel_awqos,
    input  wire        i_sobel_awvalid,
    output wire        o_sobel_awready,
    input  wire  [3:0] i_sobel_arid,
    input  wire [31:0] i_sobel_araddr,
    input  wire  [7:0] i_sobel_arlen,
    input  wire  [2:0] i_sobel_arsize,
    input  wire  [1:0] i_sobel_arburst,
    input  wire        i_sobel_arlock,
    input  wire  [3:0] i_sobel_arcache,
    input  wire  [2:0] i_sobel_arprot,
    input  wire  [3:0] i_sobel_arregion,
    input  wire  [3:0] i_sobel_arqos,
    input  wire        i_sobel_arvalid,
    output wire        o_sobel_arready,
    input  wire [63:0] i_sobel_wdata,
    input  wire  [7:0] i_sobel_wstrb,
    input  wire        i_sobel_wlast,
    input  wire        i_sobel_wvalid,
    output wire        o_sobel_wready,
    output wire  [3:0] o_sobel_bid,
    output wire  [1:0] o_sobel_bresp,
    output wire        o_sobel_bvalid,
    input  wire        i_sobel_bready,
    output wire  [3:0] o_sobel_rid,
    output wire [63:0] o_sobel_rdata,
    output wire  [1:0] o_sobel_rresp,
    output wire        o_sobel_rlast,
    output wire        o_sobel_rvalid,
    input  wire        i_sobel_rready,
  ...
  localparam int unsigned NoMasters   = 32'd4;    // How many Axi Masters there are
  ...
  localparam rule_t [1:0] AddrMap = '{
   ...
   slv_req_t  [3:0] masters_req;
   slv_resp_t [3:0] masters_resp;
   ...
   //Master sobel
   assign masters_req[3].aw.id = i_sobel_awid;
   assign masters_req[3].aw.addr = i_sobel_awaddr;
   assign masters_req[3].aw.len = i_sobel_awlen;
   assign masters_req[3].aw.size = i_sobel_awsize;
   assign masters_req[3].aw.burst = i_sobel_awburst;
   assign masters_req[3].aw.lock = i_sobel_awlock;
   assign masters_req[3].aw.cache = i_sobel_awcache;
   assign masters_req[3].aw.prot = i_sobel_awprot;
   assign masters_req[3].aw.region = i_sobel_awregion;
   assign masters_req[3].aw.qos = i_sobel_awqos;
   assign masters_req[3].aw.atop = 6'd0;
   assign masters_req[3].aw_valid = i_sobel_awvalid;
   assign o_sobel_awready = masters_resp[3].aw_ready;
   assign masters_req[3].ar.id = i_sobel_arid;
   assign masters_req[3].ar.addr = i_sobel_araddr;
   assign masters_req[3].ar.len = i_sobel_arlen;
   assign masters_req[3].ar.size = i_sobel_arsize;
   assign masters_req[3].ar.burst = i_sobel_arburst;
   assign masters_req[3].ar.lock = i_sobel_arlock;
   assign masters_req[3].ar.cache = i_sobel_arcache;
   assign masters_req[3].ar.prot = i_sobel_arprot;
   assign masters_req[3].ar.region = i_sobel_arregion;
   assign masters_req[3].ar.qos = i_sobel_arqos;
   assign masters_req[3].ar_valid = i_sobel_arvalid;
   assign o_sobel_arready = masters_resp[3].ar_ready;
   assign masters_req[3].w.data = i_sobel_wdata;
   assign masters_req[3].w.strb = i_sobel_wstrb;
   assign masters_req[3].w.last = i_sobel_wlast;
   assign masters_req[3].w_valid = i_sobel_wvalid;
   assign o_sobel_wready = masters_resp[3].w_ready;
   assign o_sobel_bid = masters_resp[3].b.id;
   assign o_sobel_bresp = masters_resp[3].b.resp;
   assign o_sobel_bvalid = masters_resp[3].b_valid;
   assign masters_req[3].b_ready = i_sobel_bready;
   assign o_sobel_rid = masters_resp[3].r.id;
   assign o_sobel_rdata = masters_resp[3].r.data;
   assign o_sobel_rresp = masters_resp[3].r.resp;
   assign o_sobel_rlast = masters_resp[3].r.last;
   assign o_sobel_rvalid = masters_resp[3].r_valid;
   assign masters_req[3].r_ready = i_sobel_rready;
